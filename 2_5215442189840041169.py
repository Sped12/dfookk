...
def setting():
	print("\033[2;36m ~~~~~~~~~~~~~~~~~~~~~~~")
	print(f'» 1- الاولويه في الفحص للحسابات القديمه')
	print('» 2-  الاولويه في الفحص للحسابات الجديده')
	print('» 3-  قـديـمـه وجـديده ')
	print('')
	hu = input('» Chose&اختار : ')
	if hu in ['1','01']:
...
#		method.append('touch')
		...
		method.append('mobile')
	print('')
	_jembot_ = input('>> Add App : اظهار التطبيقات المرتبطه اختار T( Y/t ) ')
	if _jembot_ in ['']:
		...
		taplikasi.append('no')
	pwplus=input('>> Password Manual : باسورد يدوي اختار T (T عشوائي)( Y/t ) ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				...
				if len(frs)<3:
					...
					pwv.append('aaaassss')
					pwv.append('qwertyuiopasdfghjkl')
					pwv.append('qwertyuiopasdfghjklzxcvbnmصص')
					pwv.append('10002000')
					pwv.append('12345@@@@@')
					pwv.append('١٢٣٤٥٦')
					pwv.append('zzxxccvv')
